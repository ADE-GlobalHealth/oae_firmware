...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ADC_Interrupt_GPIO_Port, ADC_Interrupt_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : MSC_Pin */
  GPIO_InitStruct.Pin = MSC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(MSC_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : ADC_Interrupt_Pin */
  GPIO_InitStruct.Pin = ADC_Interrupt_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ADC_Interrupt_GPIO_Port, &GPIO_InitStruct);
...
/* USER CODE BEGIN 4 */
void HAL_SAI_RxCpltCallback(SAI_HandleTypeDef *hsai_BlockA2){
	  	i2s_sample = data_i2s[0];
}
/* USER CODE END 4 */
